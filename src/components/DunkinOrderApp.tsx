...
const dunkinMenu = [
  {
    name: "Glazed Donut",
    image:
      "https://cdn3d.iconscout.com/3d/premium/thumb/doughnut-3d-icon-download-in-png-blend-fbx-gltf-file-formats--delicious-logo-donat-bagel-food-pack-drink-icons-5299286.png",
    price: 1.49,
    category: "donut",
  },
  {
    ...
    image:
      "https://png.pngtree.com/png-clipart/20240901/original/pngtree-boston-cream-donut-png-image_15904461.png",
    price: 2.5,
    category: "donut",
  },
  {
    ...
    image:
      "https://cdn3d.iconscout.com/3d/premium/thumb/donut-3d-icon-download-in-png-blend-fbx-gltf-file-formats--delicious-logo-doughnut-bakery-cake-breakfast-favorite-food-pack-drink-icons-8550474.png",
    price: 1.89,
    category: "donut",
  },
  {
    name: "Iced Coffee",
    image:
      "https://dunkin.co.uk/media/catalog/product/cache/59f43ce58882b8d0a2cdacb95e7b95d8/f/r/frozen-dunkin-coffee_1.png",
    price: 2.99,
    category: "beverage",
  },
  {
  ...
  },
  {
    ...
    image:
      "https://hips.hearstapps.com/hmg-prod/images/strawberry-coollatta-1577974044.png?crop=0.551xw:0.898xh;0.219xw,0.0953xh&resize=980:*",
    price: 3.79,
    category: "beverage",
  },
  {
    ...
    image:
      "https://png.pngtree.com/png-clipart/20240327/original/pngtree-cute-chocolate-chip-cookie-png-image_14689318.png",
    price: 1.29,
    category: "cookies",
  },
  {
    ...
    image:
      "https://png.pngtree.com/png-clipart/20240227/original/pngtree-oatmeal-raisin-cookie-dessert-photo-png-image_14426860.png",
    price: 1.29,
    category: "cookies",
  },
  {
    name: "Powdered Donut",
    image:
      "https://png.pngtree.com/png-vector/20230831/ourmid/pngtree-pink-strawberry-donut-with-sprinkles-illustration-png-image_9969629.png",
    price: 1.59,
    category: "donut",
  },
  {
...
const getMenuItems = (query: string) => {
  ...
  const nonBeverages = dunkinMenu.filter(
...
export const DunkinOrderApp: React.FC = () => {
  ...
  const [checkoutStep, setCheckoutStep] = React.useState<
    "items" | "details" | "payment" | "confirmation"
  >("items");
  ...
  const generateRandomCards = (messageId: number) => {
    ...
    const numOtherCards = Math.floor(Math.random() * 2) + 1;
    const selectedItems = [
      ...shuffledNonBeverages.slice(0, numOtherCards),
      randomBeverage,
    ];
  ...
  const calculateTotal = (cards: any[]) => {
    return cards
      .reduce(
        (total, card) => total + parseFloat(card.price) * quantities[card.id],
        0
      )
      .toFixed(2);
  };
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const botResponse = {
      ...
      options: input.toLowerCase().includes("order")
        ? ["Donuts", "Coffee", "Breakfast Sandwiches", "Bagels"]
        : undefined,
    };
